...
namespace MalbersAnimations
{
    ...
    public class AnimalEditor : Editor
    {
        ...
        protected SerializedProperty
            ...
            GotoSleep, SnapToGround, waterLine, swimSpeed, underWaterSpeed, bank,
        ...
        protected void DrawAnimalInspector()
        {
            ...
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            EditorGUI.indentLevel++;
            myAnimal.EditorAttributes = EditorGUILayout.Foldout(myAnimal.EditorAttributes, "Atributes");
            EditorGUI.indentLevel--;
            ...
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            EditorGUI.indentLevel++;
            myAnimal.EditorAirControl = EditorGUILayout.Foldout(myAnimal.EditorAirControl, "Air Control");
            EditorGUI.indentLevel--;
            if (myAnimal.EditorAirControl)
            {
                ...
                EditorGUILayout.PropertyField(forwardJumpControl, new GUIContent("Jump Control", "Enables Stop moving forward while jumping"));
