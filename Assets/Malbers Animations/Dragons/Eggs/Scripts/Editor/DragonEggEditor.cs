...
namespace MalbersAnimations
{
    ...
    public class DragonEggEditor : Editor
    {
        ...
        DragonEgg DE;
        private SerializedProperty input, time, click, hatchtype;
        ...
        public override void OnInspectorGUI()
        {
            ...
            //EditorGUILayout.PropertyField(serializedObject.FindProperty("eggAnimation"), new GUIContent("Egg Animation", "Start Animation"));
