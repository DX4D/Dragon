...
namespace MalbersAnimations.Utilities
{
    ...
    public class AnimEventSoundEditor : Editor
    {
        ...
        void HeaderCallbackDelegate(Rect rect)
        {
            ...
            EditorGUI.LabelField(R_1, "Animation Event");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.HelpBox("Recieve Animations Events from the Animations Clips to play Sounds using the function (PlaySound (string Name))", MessageType.None);
